...
var community_commMember={
    ...
    getUsersByCommunityId(id,callback){
        return db.query("select cm.fk_user_id,u.user_pic from user_tbl u,comm_member_tbl cm,communities_tbl co where co.comm_id=cm.fk_comm_id and u.user_id=cm.fk_user_id and co.comm_id=?",[id],callback)
    }
}
