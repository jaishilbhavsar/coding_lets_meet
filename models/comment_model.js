...
var comment = {
    ...
    addComment: function (cm, callback) {
        ...
        console.log(cm);
        return db.query("INSERT INTO comment_tbl(com_id, com_date, com_des, fk_post_id, com_fk_user_id) VALUES (?,CURRENT_DATE,?,?,?)", [null, cm.com_des, cm.fk_post_id, cm.com_fk_user_id], callback);
